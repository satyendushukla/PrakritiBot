...
PATH = os.getcwd()
model = load(rf"/home/satyendushukla/Downloads/prakriti_Determin/bot/models/nlm")
prakrit_model = load(rf"/home/satyendushukla/Downloads/prakriti_Determin/bot/models/trained_model")

# Importing the Sentence intent .csv file
df = pd.read_csv(rf"/home/satyendushukla/Downloads/prakriti_Determin/bot/dataset/sentences_intent.csv")
